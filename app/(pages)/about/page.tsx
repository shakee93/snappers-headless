  ...
  return (
    <main className="flex flex-col gap-10">
      ...
      <div className="relative flex flex-col justify-center items-center w-full bg-aboutus-frame bg-cover bg-center bg-no-repeat h-[230px]">
        ...
        <div className="z-10 font-semibold text-2xl text-[#f3f30b]">About</div>
        <div className="z-10 font-semibold text-3xl text-white">Discover Our Story: Unveiling the Essence of Our Journey</div>
      </div>
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-row gap-2">
          {stats.map((stat, index) => (
            <div key={index} className="w-1/4 rounded-2xl bg-white p-4">
