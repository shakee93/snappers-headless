  ...
  return (
    <main className="flex flex-col gap-10">
      ...
      <div className="flex gap-5 h-[380px] " id="hero-section">
        ...
        <div className="w-4/12 shadow-2xl shadow-[#E5E5E5]  p-3 border-[1.5px] rounded-lg">
          <HeroFeaturesSection />
        </div>
      </div>
      <div
        className="flex gap-5 p-5 bg-gradient-to-r from-[#FF585C] to-[#F1E92A] border-[1.5px] rounded-lg"
        id="offer-section"
      >
        <div className="w-3/12 p-2 flex flex-col justify-center gap-3">
          <div className="font-bold text-2xl text-white leading-tight">Check out our Snap Deals</div>
          <div className="font-normal text-base text-white">Shop with Snappers</div>
          <Button className="bg-snap_yellow text-snap_blue text-base font-bold w-max">Go to Deals <FaChevronCircleRight className="ml-3"/></Button>
        </div>
